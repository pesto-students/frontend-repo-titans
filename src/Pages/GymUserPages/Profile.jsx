...
import { setProfileLoadingFalse, setProfileLoadingTrue } from "../../redux/profileSkeleton.js";
...
const Profile = () => {
  ...
  const profileLoading = useSelector((state) => state.isProfileLoading.profile.loading);
  ...
  return (
    <>
      {profileLoading ? (<ProfileSkeleton />) : (<div className="flex items-center justify-center mt-4 text-white bg-wwbg md:my-12">
